                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="mb-16">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <PlanCard {...planData.Formation} onSelect={() => router.push('/onboarding?planName=Formation&state=Dubai&entityType=FreeZone&country=UAE&amount=1999')} />
                        <PlanCard {...planData.Compliance} onSelect={() => router.push('/onboarding?planName=Compliance&state=Dubai&entityType=FreeZone&country=UAE&amount=2999')} />
                        <PlanCard {...planData.AllInOne} onSelect={() => router.push('/onboarding?planName=AllInOne&state=Dubai&entityType=FreeZone&country=UAE&amount=4999')} />
                    </div>
                </div>
            </section>
